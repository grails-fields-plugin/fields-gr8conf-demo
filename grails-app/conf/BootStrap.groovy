...
class BootStrap {
    ...
    def init = { servletContext ->
    	...
    	new Person(salutation: Mr, firstName: 'Bart', lastName: 'Simpson', gender: male, birthDate: new Date(89, 11, 17), email: 'bart@eatmyshor.ts', address: new Address(street: '57 Evergreen Terrace', city: 'Springfield', country: 'USA')).save(failOnError: true)
    }
